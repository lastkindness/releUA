<section <?php if($id = get_sub_field('id')): echo 'id="' . $id . '"'; endif;?> <?php if($id = get_sub_field('id')): echo 'id="' . $id . '"'; endif;?>
    class="accordion">
    <div class="container">
        <?php if($accordion_block_title=get_sub_field('accordion_block_title')):?>
            <h2><?php echo $accordion_block_title;?></h2>
        <?php endif;?>
        <div class="handorgel">
