<section <?php if($id = get_sub_field('id')): echo 'id="' . $id . '"'; endif;?> class="cards-block all-estate">
    <div class="container">
        <?php if($title = get_sub_field('title')): ?>
            <h1 class="h4 all-estate__title"><?php echo $title;?></h1>
        <?php endif; ?>
        <div class="all-estate__wrapper">
            <?php
            function is_mobile() {
            ...
            if (is_mobile()) { ?>
                <aside id="estate-filter" class="estate-filter all-estate__filter all-estate__filter_mobile">
                    <?php
                    ...
                    <div class="handorgel">
                        ...
                        <div class="taxonomy-filter estate-filter__filter">
                            <?php if($floor_filter):?>
                                <h6 class="estate-filter__title handorgel__header">
                                    <button class="handorgel__header__button"><?php echo $floor_filter;?></button>
                                </h6>
                            <?php endif;?>
                            <div class="handorgel__content">
                                <div class="handorgel__content__inner">
                                    <?php $floor_numbers = array();
                                    $args = array(
                                        'post_type' => 'estate',
                                        'posts_per_page' => -1,
                                    );
                        ...
                        <div class="taxonomy-filter estate-filter__filter">
                            <?php if($backlight_filter):?>
                                <h6 class="estate-filter__title handorgel__header">
                                    <button class="handorgel__header__button"><?php echo $backlight_filter;?></button>
                                </h6>
                            <?php endif;?>
                            <div class="handorgel__content">
                                <div class="handorgel__content__inner">
                        ...
                        <div class="taxonomy-filter estate-filter__filter">
                            <?php if($number_of_parking_spaces_filter):?>
                                <h6 class="estate-filter__title handorgel__header">
                                    <button class="handorgel__header__button"><?php echo $number_of_parking_spaces_filter;?></button>
                                </h6>
                            <?php endif;?>
                            <div class="handorgel__content">
                                <div class="handorgel__content__inner">
                                    <?php $parking_spaces = array();
                                    $args = array(
                                        'post_type' => 'estate',
                                        'posts_per_page' => -1,
                                    );
            ...
            <?php } else { ?>
                <aside id="estate-filter" class="estate-filter all-estate__filter">
                    <?php
                    $area_filter = get_field('area_filter', 'option-estate');
                    $rental_price_filter = get_field('rental_price_filter', 'option-estate');
                    $selling_price_filter = get_field('selling_price_filter', 'option-estate');
                    ...
                    <div class="taxonomy-filter estate-filter__filter">
                        <?php if($floor_filter):?>
                            <h6 class="estate-filter__title"><?php echo $floor_filter;?></h6>
                        <?php endif;?>
                        <?php
                        $floor_numbers = array();
                        $args = array(
                    ...
                    <div class="taxonomy-filter estate-filter__filter">
                        <?php if($backlight_filter):?>
                            <h6 class="estate-filter__title"><?php echo $backlight_filter;?></h6>
                        <?php endif;?>
                        <?php
                        $backlights = array();
                        $args = array(
                    ...
                    <div class="taxonomy-filter estate-filter__filter">
                        <?php if($number_of_parking_spaces_filter):?>
                            <h6 class="estate-filter__title"><?php echo $number_of_parking_spaces_filter;?></h6>
                        <?php endif;?>
                        <?php
            ...
            <?php } ?>
            <section class="cards-grid all-estate__grid" id="cards-grid">
