            ...
            ?>
                <div class="article-section">
                    <div class="article-section__wrapper">
                        <?php if($main_images):?>
                            <section class="article-section__gallery gallery">
                                <div class="container">
                                    <div class="row">
                        ...
                        <?php endif;?>
                        <section class="article-section__info">
                            <div class="container">
                                <div class="article-section__wrapper">
                                        ...
                                        <ul class="article-section__characteristic-list">
                                            ...
                                            <?php if($object_area):?>
                                                <li class="article-section__characteristic">
                                                    ...
                                                    <span class="text"><?php echo $object_area;?> м²</span>
                                                </li>
                                            <?php endif;?>
                                            ...
                                            <?php if($floor):?>
                                                <li class="article-section__characteristic">
                                                    ...
                                                    <span class="text"><?php echo $floor;?></span>
                                                </li>
                                            <?php endif;?>
                                            <li class="article-section__characteristic">
                        ...
                        <?php if($form_text):?>
                            <section class="form article-section__form">
                                <div class="container">
                        ...
                        <?php if($slider_images):?>
                            <section class="slider-img article-section__slider-img">
                                <div class="container">
